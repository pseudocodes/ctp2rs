...
```toml
[dependencies]
ctp2rs = { git = "https://github.com/pseudocodes/ctp2rs", path = "./ctp-dyn" }
...
```toml
[dependencies]
ctp2rs = { version = "0.1.x", features = ["ctp_v6_7_7"] }
```
...
* 同上，当需要切换 CTP API 柜台时，部署时需要通过环境变量替换动态库，无法在同一个程序中访问多种柜台
* 基本不支持 MacOS 平台
